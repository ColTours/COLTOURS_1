...
public class UsuarioController implements IUsuarioController {
   ...
   @Override 
    public String modificar(String id_usuario, String nuevaContrasena, 
        ...
        String sql = "Update usuario set contrasena = '" + nuevaContrasena + "', nombre = '" + nuevoNombre + "', apellidos = '" + nuevosApellidos + "', email = '" + nuevoEmail + "', direccion= '" + nuevaDireccion + "', ciudad= '" + nuevaCiudad + "', telefono= '" + nuevoTelefono + "' where id_usuario = " + id_usuario ;
