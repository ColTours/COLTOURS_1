...
public class DestinoController implements IDestinoController {
   ...
   @Override
    ...
    @Override
    public String registerPlan(int id_destino, String planes, Double precio, String ciudad) { //String email, String direccion, String  ciudad, String  telefono

        Gson gson = new Gson();

        DBConnection con = new DBConnection();  // + "', '" + email + "', '" + direccion + "','" + ciudad + "','" + telefono + "'
        String sql = "Insert into destino values('" + id_destino + "', '" + planes + "', '" + precio+ "', '" + ciudad+"')"; 
        ...
        try {
            ...
            Destino destino = new Destino(id_destino, planes, precio, ciudad); //, email, direccion, ciudad, telefono
